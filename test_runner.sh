...
# "cometbft_networking" "batch_pegins" "block_builder" "utxo_sync" "frost_e2e_stable" "frost_e2e_failed_signing_disconnect" "invalid_pegin" "invalid_pegout" "test_mempool_gossip" "rpc_node"
# Add these back in as we fix the test suite
tests_to_run=("dkg_flow" "utxo_commitment" "many_inputs_signing")
