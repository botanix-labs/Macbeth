...
tests_to_run=("dkg_flow" "many_inputs_signing" "batch_pegins" "utxo_commitment" "block_builder" "utxo_sync" "frost_e2e_stable" "frost_e2e_failed_signing_disconnect" "invalid_pegin" "invalid_pegout" "test_mempool_gossip" "rpc_node")
