...
pub mod multi_mint_helper_contract {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        ...
                        inputs: ::std::vec![
                            ...
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("bitcoinBlockHeight1",),
                            ...
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("bitcoinBlockHeight2",),
                                kind: ::ethers::core::abi::ethabi::ParamType::Uint(32usize),
                                internal_type: ::core::option::Option::Some(
                                    ::std::borrow::ToOwned::to_owned("uint32"),
                                ),
    ...
    pub static MULTIMINTHELPERCONTRACT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static MULTIMINTHELPERCONTRACT_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static MULTIMINTHELPERCONTRACT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    ///Container type for all input parameters for the `multiMintTwo` function with signature
    /// `multiMintTwo(address,uint256,uint32,bytes,address,address,uint256,uint32,bytes,address)`
    /// and selector `0xe39bfe46`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for MultiMintHelperContractCalls {
        fn decode(
            ...
            if let Ok(decoded) = <MultiMintTwoCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for MultiMintHelperContractCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::MultiMintTwo(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
