...
use crate::suite::consensus::{common::poa_node::TestSignal, ConsensusIntegrationTestSuite};
use bitcoin::Address;
...
pub async fn test_utxo_sync(suite: &ConsensusIntegrationTestSuite) -> Result<(), Error> {
