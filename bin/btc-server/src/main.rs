...
mod rpc {
    ...
    pub use btc_server::btc_server_server::{BtcServer, BtcServerServer};
    pub use btc_server::*;
}
...
use bitcoin::{FeeRate, OutPoint, Transaction, TxOut};
use clap::Parser;
use hex::FromHex;
...
mod test {
    ...
    fn test_tx() {
        ...
        let out1 = "8f14fbdee5a62ffcedd2915b2616605a6b08c73dcadf9c43f3727038edcf991a:1"
            .parse()
            .unwrap();

        let eth2 = hex::decode("2759bC7b8f9F2b47eEeFFB2f5751E0CFF3fF1aD8").unwrap();
        let out2 = "c0ea9dc0029bb844a231887655e4b9f80eab4d11804c8af28dd618d073eed7de:2"
            .parse()
            .unwrap();
        ...
        assert_eq!(
            change.output.script_pubkey.to_hex_string(),
            change_script.to_hex_string()
        );
    ...
    fn test_spending_change() {
        ...
        // Add change output
        let out = "8f14fbdee5a62ffcedd2915b2616605a6b08c73dcadf9c43f3727038edcf991a:1"
            .parse()
            .unwrap();
        app.add_pegin(&Utxo {
            outpoint: out,
