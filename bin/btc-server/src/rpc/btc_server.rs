...
pub struct NotifyPegoutsRequest {
...
pub mod btc_server_server {
    ...
    pub trait BtcServer: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn notify_pegouts(
            &self,
            request: tonic::Request<super::NotifyPegoutsRequest>,
        ) -> std::result::Result<tonic::Response<super::Empty>, tonic::Status>;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/btc_server.BtcServer/TxIndexNewCheckpoint" => {
                    #[allow(non_camel_case_types)]
                    struct TxIndexNewCheckpointSvc<T: BtcServer>(pub Arc<T>);
                    impl<
                        T: BtcServer,
                    > tonic::server::UnaryService<super::SyncTxIndexRequest>
                    for TxIndexNewCheckpointSvc<T> {
                        type Response = super::Empty;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BtcServer>::tx_index_new_checkpoint(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = TxIndexNewCheckpointSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/btc_server.BtcServer/NotifyPegins" => {
                    ...
                    impl<
                        T: BtcServer,
                    > tonic::server::UnaryService<super::NotifyPeginsRequest>
                    for NotifyPeginsSvc<T> {
                        type Response = super::Empty;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                ...
                "/btc_server.BtcServer/NotifyPegouts" => {
                    #[allow(non_camel_case_types)]
                    struct NotifyPegoutsSvc<T: BtcServer>(pub Arc<T>);
                    impl<
                        T: BtcServer,
                    > tonic::server::UnaryService<super::NotifyPegoutsRequest>
                    for NotifyPegoutsSvc<T> {
                        type Response = super::Empty;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BtcServer>::notify_pegouts(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = NotifyPegoutsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
