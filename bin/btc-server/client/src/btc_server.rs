...
pub mod btc_server_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn tx_index_new_checkpoint(
            &mut self,
            request: impl tonic::IntoRequest<super::SyncTxIndexRequest>,
        ) -> std::result::Result<tonic::Response<super::Empty>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        pub async fn notify_pegins(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("btc_server.BtcServer", "NotifyPegins"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn notify_pegouts(
            &mut self,
            request: impl tonic::IntoRequest<super::NotifyPegoutsRequest>,
        ) -> std::result::Result<tonic::Response<super::Empty>, tonic::Status> {
            self.inner
                .ready()
                .await
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("btc_server.BtcServer", "NotifyPegouts"));
            self.inner.unary(req, path, codec).await
        }
