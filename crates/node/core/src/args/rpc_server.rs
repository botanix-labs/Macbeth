    ...
    fn default() -> Self {
        Self {
            ...
            bitcoind: BitcoindArgs {
                primary_url: "localhost:18443".parse::<Url>().expect("valid bitcoind address"),
                primary_username: DEFAULT_BITCOIND_USERNAME.to_string(),
                primary_password: DEFAULT_BITCOIND_PASSWORD.to_string(),
                secondary_url: "localhost:18443".parse::<Url>().expect("valid bitcoind address"),
                secondary_username: DEFAULT_BITCOIND_USERNAME.to_string(),
                secondary_password: DEFAULT_BITCOIND_PASSWORD.to_string(),
