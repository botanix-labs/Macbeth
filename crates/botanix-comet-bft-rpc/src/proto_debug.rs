...
pub struct RequestProcessProposalTruncatedDebug<'a>(pub &'a RequestProcessProposal);
...
/// It uses [TruncatedSlice] to limit the number of transactions displayed in the debug output.
pub struct ResponsePrepareProposalTruncatedDebug<'a>(pub &'a ResponsePrepareProposal);
...
pub struct RequestApplySnapshotChunkTruncatedDebug<'a>(pub &'a RequestApplySnapshotChunk);
...
/// It uses [TruncatedSlice] to limit the number of chunk bytes displayed in the debug output.
pub struct ResponseLoadSnapshotChunkTruncatedDebug<'a>(pub &'a ResponseLoadSnapshotChunk);
...
/// It uses [TruncatedSlice] to limit the number of transactions displayed in the debug output.
pub struct RequestFinalizeBlockTruncatedDebug<'a>(
