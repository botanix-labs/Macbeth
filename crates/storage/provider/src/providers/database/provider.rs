...
impl<TX: DbTx> SnapshotReader for DatabaseProvider<TX> {
    fn get_chunk_block_height(
        &self,
    ...
    fn get_snapshot_by_id(
        &self,
        snapshot_id: reth_db::models::SnapshotId,
    ) -> ProviderResult<Option<reth_db::models::Snapshot>> {
    ...
    ) -> ProviderResult<Option<reth_db::models::SnapshotId>> {
