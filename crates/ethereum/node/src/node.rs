...
use reth_provider::{
    providers::{BlockchainProvider2, ProviderFactory, StaticFileProvider},
    ...
    Node: FullNodeTypes<ChainSpec = ChainSpec>,
{
    ...
    async fn build_evm(
        ...
        let blockchain_db = Arc::new(BlockchainProvider2::new(provider_factory).expect("Failed to create blockchain provider"));
        let executor = EthExecutorProvider::new(chain_spec, evm_config, mock_bitcoind_factory, regtest, blockchain_db);
